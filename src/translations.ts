export const translations = {
    en: {
        ...
        contactText: "I'm always open to new opportunities and interesting projects. Feel free to reach out if you'd like to collaborate!",
    ...
    ru: {
        ...
        bestPracticesDesc: 'Следование отраслевым стандартам вместе с современными фреймворками и инструментами',
        learning: 'Обучение',
        ...
        contact: 'Связаться',
        contactText: 'Я всегда открыт для новых возможностей и интересных проектов. Свяжитесь со мной, если хотите сотрудничать!',
